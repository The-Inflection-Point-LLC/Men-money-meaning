...
export const DEMO_TESTIMONIES = [
    {
        id: 1,
        link: "https://www.greenwichschools.org/",
        name: "Greenwich Public Schools Logo",
        img: GreenwichPublicSchoolsLogo,
    },
    {
        id: 2,
    ...
    {
        id: 7,
        link: "https://medicine.yale.edu/childstudy/",
        name: "Yale Child study center",
        img: YaleChildStudyCenter,
    },
    {
        id: 8,
        link: "https://www.psych.uic.edu/",
        name: "UIC",
        img: UIC,
    },
    {
...
export const DEMO_WHAT_MAKES_DIFFERENT = [
    {
        id: 1,
        title: "Clear steps to progress",
        color: "#906F2E",
        desc: `The path to stronger relationships can confusing and fuzzy.\nAnd not knowing which way to go undercuts your motivation to keep going.\n\nIn all or our services, we start with a clear goal and monitor progress.\n\nWe shift tactics as needed but keep the same goal.\nLearning what works and what doesn’t along the way.\n\nBecause “if you don’t know where you are going, you will end up somewhere else.” \n– Yogi Berra`,
        img: [ClearProgress],
        moreInfo: {
            title: "",
    ...
    },
    {
        ...
        color: "#DF7A2E",
        desc: `Each of our challenges is different.  Our situations, unique.\n\nAnd yet we do not need to reinvent the wheel.  There are well-known pathways for many of life’s requirements.\n\nAnd striking this balance between your particular situation and general/universal truths makes your path to change more time and cost effective.\n\nWe need to find the right path for you.\n\nAsk Mitch about the Task -> Relationship -> Results model of agile learning.`,
        img: [PersonalizePathBG],
    },
    {
        id: 3,
        title: "Directly based on science",
        color: "#718980",
        img: [ScienceBased],
        desc: `Over the last 50 years findings from 16 different scientific disciplines have converged to illuminate just how important relationships are to health and happiness. \n\nOur most important relationships impact: \n<t>1.	immune system</t> \n<t>2. social, mental, and emotional health</t> \n<t>3. career success and satisfaction</t> \n<t>4. brain functioning</t> \n<t>5. financial resources/wealth</t>\n<t>6. physicla health and longevity – how long we live</t>\n<t>7. all the way down to the lives our grandchildren will lead</t>\n\nWe make use of this science in our work with you.`,
    },
    {
        id: 4,
        title: "Stronger together",
        color: "#266480",
        desc: `Covid taught us that living in isolation is just plain ugly. \nWe thrive when we are socially connected with others. \n\nAnd it’s the same when we want to become mentally, physically, emotionally stronger.\n\nIt’s more\n<t>enjoyable in experience,</t>\n<t>more effective in outcomes,</t>\n<t>and more efficient in time and money</t>\n<t>when we learn new things in a safe, social context.</t>`,
        img: [StrongerTogether2],
    },
    {
        id: 5,
        title: "Multidisciplinary",
        color: "#5C8F95",
        desc: `Therapy has its own ethos, values and lingo.  At its worst, it lapses into psychobabble. \n\nSo we borrow:\n<t>1) just-in-time methods from the corporate training and development industry</t>\n<t>2) lean startup ideas from Silicon Valley for new services</t>\n<t>3) measurement methods from project management principles in business</t>\n\nAsk us how we developed our (P+R)*M > S+C model to scope goals and adjust your path to them.`,
    },

    {
        ...
        title: "Tool use",
        color: "#048404",
        desc: `The use of tools has been a competitive advantage since humans started making hammerstones and sharp stone flakes about 2.6 million years ago.\n\nAnd here in 2024, tool use is an advantage for my clients. For two reasons:\n<t><m>1)</m>Initial forms and questionnaires allow us to begin to understand what’s important to you, even before we meet.</t>\n<t><m>2)</m>And since about 75% of gains you make depend on what you do, these tools provide a way for you to learn and grow outside of our meeting times. And we can keep in touch in between meetings.</t>\n\nSome tools are currently being clinically-validated and are therefore free to use.\nContact us and we will give you access.`,
        img: [Hammerstones],
        moreInfo: {
            title: "",
